...
const EditBook = () => {
  ...
  return (
    <div className='p-4'>
      <BackButton />
      <h1 className='text-3xl my-4 flex items-center justify-center text-white'>Editar Recomendação</h1>
      ...
      <div className='flex flex-col rounded-xl w-[600px] p-4 mx-auto bg-slate-200 shadow-lg shadow-indigo-900'>
        ...
        <button className='p-2 bg-lime-500 rounded-full m-8 shadow-lg shadow-indigo-500' onClick={handleEditBook}>
          Salvar
        </button>
      </div>
    </div>
